...
_PATH_TO_WASM = "/home/jh/mywork/keymanagement/target/wasm32-unknown-unknown/release/add_associated_key.wasm"
...
# CLI argument: path to contract operator secret key - defaults to casper-test faucet.
_ARGS.add_argument(
...
# CLI argument: path to smart contract wasm binary - defaults to add_associated_key.wasm.wasm.
_ARGS.add_argument(
    "--path-to-wasm",
...
# CLI argument: host address of target node - defaults to casper-test.
_ARGS.add_argument(
    "--node-host",
...
# CLI argument: path of associated key path.
_ARGS.add_argument(
    "--path_to_account_key",
